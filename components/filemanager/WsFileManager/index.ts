...
import { WsFileManagerComponent } from "./WsFileManager";
...
export class WsFileManager implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsFileManagerComponent, props);
    } catch (error: any) {
