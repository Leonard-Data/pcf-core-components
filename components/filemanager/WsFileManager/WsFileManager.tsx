...
import { IWsFileManager, Record } from "./types";

/**
 * Renders WsFileManager component.
 *
 * @param {IWsFileManager} props - The props for the FileManager component.
 * @returns {JSX.Element} - The rendered FileManager component.
 */
export const WsFileManagerComponent: React.FC<IWsFileManager> = React.memo((props: IWsFileManager) => {
...
WsFileManagerComponent.displayName = "WsFileManagerComponent";
