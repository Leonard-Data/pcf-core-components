...
import { WsAccordionComponent } from "./WsAccordion";
...
export class WsAccordion implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        try {
            ...
            return React.createElement(WsAccordionComponent, props);
        } catch (error: any) {
