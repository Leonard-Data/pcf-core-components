...
import { WsTreeGridComponent } from "./WsTreeGrid";
...
export class WsTreeGrid implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsTreeGridComponent, props);
    } catch (error: any) {
      console.error(error);
