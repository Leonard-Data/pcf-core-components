...
import { IWsTreeGrid, ITreeGridConfig } from "./types";

/**
 * Renders WsTreeGrid component.
 *
 * @param {IWsTreeGrid} props - The props for the TreeGrid component.
 * @returns {JSX.Element} - The rendered TreeGrid component.
 */
export const WsTreeGridComponent: React.FC<IWsTreeGrid> = React.memo((props: IWsTreeGrid) => {
  ...
  /**
   * Handles the click event of the toolbar items in the WsTreeGrid component.
...
WsTreeGridComponent.displayName = "WsTreeGridComponent";
