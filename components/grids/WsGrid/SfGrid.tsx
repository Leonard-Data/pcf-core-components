...
/**
 * Renders a WsGrid component with various features such as editing, paging, sorting, grouping, filtering, etc.
 *
 * @param {IWsGrid} props - The props for the Grid component.
 * @returns {JSX.Element} - The rendered Grid component.
 */
export const WsGridComponent: React.FC<IWsGrid> = React.memo((props: IWsGrid) => {
  const {
    dataSource,
    columns,
    width,
  ...
  /**
   * Represents the toolbar options for the WsGrid component.
   */
...
WsGridComponent.displayName = "WsGridComponent";
