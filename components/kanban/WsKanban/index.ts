...
import { WsKanbanComponent } from "./WsKanban";
import {
  DataSet,
  IWsKanban,
  IKanbanConfig,
...
export class WsKanban implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsKanbanComponent, props);
    } catch (error: any) {
