...
import { WsScheduleComponent } from "./WsSchedule";
import { IInputs, IOutputs } from "./generated/ManifestTypes";
import { DataSet, IScheduleConfig, IWsSchedule, Record } from "./types";
import { isNullOrUndefined } from "@syncfusion/ej2-base";
import { timezoneData } from "@syncfusion/ej2-react-schedule";

export class WsSchedule implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      const scheduleProps: IWsSchedule = {
      ...
      return React.createElement(WsScheduleComponent, scheduleProps);
    } catch (error: any) {
