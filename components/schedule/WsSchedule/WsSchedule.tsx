...
import { IWsSchedule } from "./types";

/**
 * Represents the WsScheduleComponent component.
 *
 * @param {IWsSchedule} props - The props for the Schedule component.
 * @returns {JSX.Element} - The rendered Schedule component.
 */
export const WsScheduleComponent: React.FC<IWsSchedule> = React.memo((props) => {
...
WsScheduleComponent.displayName = "WsScheduleComponent";
