...
import { WsPdfViewerComponent } from "./WsPdfViewer";
import { IWsPdfViewer } from "./types";

export class WsPdfViewer implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        try {
            ...
            return React.createElement(WsPdfViewerComponent, props);
        } catch (error) {
            console.error(error);
