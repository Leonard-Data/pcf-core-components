...
import { IWsPdfViewer } from "./types";

/**
 * WsPdfViewerComponent is a configurable PdfViewer component that displays PDF.
 *
 * @param {IWsPdfViewer} props - The props for the PdfViewer component.
 * @returns {JSX.Element} - The rendered PdfViewer component.
 */
export const WsPdfViewerComponent: React.FC<IWsPdfViewer> = React.memo(
  (props: IWsPdfViewer) => {
    const {
      documentPath,
      enableToolbar,
...
WsPdfViewerComponent.displayName = "WsPdfViewerComponent";
