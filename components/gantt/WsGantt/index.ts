...
import { WsGanttComponent } from "./WsGantt";
import { IGanttConfig, IWsGantt, Record } from "./types";
import { isNullOrUndefined } from "@syncfusion/ej2-base";
type DataSet = ComponentFramework.PropertyTypes.DataSet;

export class WsGantt implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsGanttComponent, props);
    } catch (error: any) {
