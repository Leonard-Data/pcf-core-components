...
import { IWsGantt } from './types';

/**
 * Represents the WsGanttComponent component.
 *
 * @param {IGanttConfig} props - The props for the Gantt component.
 * @returns {JSX.Element} - The rendered Gantt component.
 */
export const WsGanttComponent: React.FC<IWsGantt> = React.memo((props: IWsGantt) => {
...
WsGanttComponent.displayName = "WsGanttComponent";
