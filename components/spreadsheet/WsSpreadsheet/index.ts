...
import { WsSpreadsheetComponent } from "./WsSpreadsheet";
import {
  DataSet,
  IWsSpreadsheet,
  Record,
...
export class WsSpreadsheet implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsSpreadsheetComponent, props);
    } catch (error: any) {
