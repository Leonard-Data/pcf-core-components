...
import { IWsSpreadsheet } from './types';
...
/**
 * Renders WsSpreadsheetComponent component.
 *
 * @param {IWsSpreadsheet} props - The props for the Spreadsheet component.
 * @returns {JSX.Element} - The rendered Spreadsheet component.
 */
export const WsSpreadsheetComponent: React.FC<IWsSpreadsheet> = React.memo((props: IWsSpreadsheet) => {
...
WsSpreadsheetComponent.displayName = "WsSpreadsheetComponent";
