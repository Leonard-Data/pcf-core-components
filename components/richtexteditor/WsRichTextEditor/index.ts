...
import { WsRichTextEditorComponent } from "./WsRichTextEditor";
import { IWsRichTextEditor } from "./types";
import { isNullOrUndefined } from "@syncfusion/ej2-base";

export class WsRichTextEditor implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsRichTextEditorComponent, props);
    } catch (error: any) {
      console.error(error);
