...
import { IWsRichTextEditor } from "./types";
import "./styles/theme.css";

/**
 * WsRichTextEditorComponent is a configurable RichTextEditor that displays formatted data.
 *
 * @param {WsRichTextEditor} props - The props for the RichTextEditor component.
 * @returns {JSX.Element} - The rendered RichTextEditor component.
 */
export const WsRichTextEditorComponent: React.FC<IWsRichTextEditor> = React.memo((props: IWsRichTextEditor) => {
...
WsRichTextEditorComponent.displayName = "WsRichTextEditorComponent";
