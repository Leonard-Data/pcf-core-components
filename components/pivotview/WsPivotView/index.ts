...
import { WsPivotViewComponent } from "./WsPivotView";
import { IWsPivotView } from "./types";

export class WsPivotView implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      const pivotViewProps: IWsPivotView = {
      ...
      return React.createElement(WsPivotViewComponent, pivotViewProps);
    } catch (error: any) {
