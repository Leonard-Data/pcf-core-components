...
import { IWsChart } from "./types";

/**
 * WsChartComponent is a configurable Chart component that displays data.
 *
 * @param {IWsChart} props - The props for the Chart component.
 * @returns {JSX.Element} - The rendered Chart component.
 */
export const WsChartComponent: React.FC<IWsChart> = React.memo((props: IWsChart) => {
...
WsChartComponent.displayName = "WsChartComponent";
