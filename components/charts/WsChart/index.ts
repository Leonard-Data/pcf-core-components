...
import { WsChartComponent } from "./WsChart";
import { Record as IRecord, IWsChart } from "./types";
type ValueType = "Double" | "DateTime" | "Category" | "DateTimeCategory";
type DataSet = ComponentFramework.PropertyTypes.DataSet;

export class WsChart implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
    try {
      ...
      return React.createElement(WsChartComponent, props);
    } catch (error: any) {
      console.error(error);
